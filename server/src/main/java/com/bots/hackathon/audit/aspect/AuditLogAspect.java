...
public class AuditLogAspect {
  ...
  public void logAuditActivity(JoinPoint joinPoint, LoggableAction loggableAction, Object result) {
    try {
      ...
      if (authentication != null && authentication.isAuthenticated()) {
        ...
        // Extremely simplified lookup for actorId since we must parse JWT details without bloat
        // In production, actorId could be extracted as a direct JWT claim instead of hitting DB.
  ...
  private String buildMetadata(JoinPoint joinPoint, Object result) throws JsonProcessingException {
