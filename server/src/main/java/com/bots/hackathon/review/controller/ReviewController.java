...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<ReviewAssignmentResponse>> assignReviewer(
        ...
        Long assignedBy = authService.resolveUserId(principal);
    ...
    public ResponseEntity<ApiResponse<ReviewResponse>> submitReview(
        ...
        Long reviewerUserId = authService.resolveUserId(principal);
        return ResponseEntity.status(HttpStatus.CREATED)
    ...
    public ResponseEntity<ApiResponse<List<ReviewResponse>>> getByApplication(
        ...
        return ResponseEntity.ok(
                ApiResponse.ok(reviewService.getReviewsByApplication(applicationId)));
    }
}
