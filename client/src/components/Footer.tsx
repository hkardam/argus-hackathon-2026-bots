      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-subtle max-w-xs">
              Empowering organisations to discover, apply, and manage grants
              efficiently. A complete lifecycle management platform.
            </p>
          </div>

          <div>
            <h3 className="text-sm font-semibold text-heading tracking-wider uppercase mb-4">
              Platform
            </h3>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-faint">
            &copy; {new Date().getFullYear()} GrantFlow Platform. All rights
            reserved.
          </p>
