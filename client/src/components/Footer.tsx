        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold text-gray-900 tracking-tight">GrantFlow</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-500 hover:text-emerald-600 transition-colors">Explore Grants</a></li>
              <li><a href="#" className="text-sm text-gray-500 hover:text-emerald-600 transition-colors">Check Eligibility</a></li>
              <li><a href="#" className="text-sm text-gray-500 hover:text-emerald-600 transition-colors">Applicant Login</a></li>
              <li><a href="#" className="text-sm text-gray-500 hover:text-emerald-600 transition-colors">Reviewer Portal</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-gray-500 hover:text-emerald-600 transition-colors">Contact Support</a></li>
