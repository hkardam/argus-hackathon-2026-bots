      ...
      <div className="h-48 w-full relative overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex flex-wrap gap-2">
          {tags.map((tag, idx) => (
            <span
              key={idx}
              className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-surface/90 text-strong backdrop-blur-sm shadow-sm"
            >
              {tag}
            </span>
          ))}
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p
                className="text-sm font-medium text-heading line-clamp-1"
                title={eligibleApplicants.join(', ')}
              >
