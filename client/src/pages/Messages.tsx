  ...
  return (
    <div className="max-w-6xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
      <div className="mb-6">
        ...
        <p className="text-slate-500 mt-1">Communicate with Program Officers regarding your applications.</p>
      </div>
          ...
          <div className="p-4 border-b border-slate-200">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-9 pr-4 py-2 text-sm rounded-xl border border-slate-200 focus:ring-2 focus:ring-emerald-500 outline-none bg-white"
              />
            </div>
          </div>
          <div className="flex-1 overflow-y-auto">
            {/* Active Thread */}
            <div className="p-4 border-b border-slate-200 bg-white cursor-pointer border-l-4 border-l-emerald-500">
              ...
              <p className="text-sm text-slate-600 line-clamp-2">Please clarify beneficiary demographics. We need the breakdown by age.</p>
            </div>
            {/* Inactive Thread */}
            <div className="p-4 border-b border-slate-200 hover:bg-slate-100 cursor-pointer transition-colors">
              <div className="flex justify-between items-start mb-1">
                <h3 className="font-medium text-slate-700 text-sm truncate">APP-101: Coastal Mangrove...</h3>
                <span className="text-xs text-slate-400 shrink-0">Jan 12</span>
              </div>
              <p className="text-sm text-slate-500 line-clamp-2">Congratulations on your grant approval. Please review the agreement.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col bg-white">
          ...
          <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center bg-white">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Programme: Community Development Grant</p>
            </div>
          ...
          <div className="flex-1 p-6 overflow-y-auto space-y-6 bg-slate-50/50">
            ...
            <div className="flex gap-4 max-w-2xl">
              ...
              <div>
                <div className="flex items-baseline gap-2 mb-1">
                  <span className="font-semibold text-sm text-slate-900">Program Officer</span>
            ...
            <div className="flex gap-4 max-w-2xl ml-auto flex-row-reverse">
              ...
              <div className="flex flex-col items-end">
                ...
                <div className="bg-emerald-600 text-white rounded-2xl rounded-tr-none p-4 shadow-sm text-sm">
                  <p>Hi,</p>
                ...
                {/* Attachment */}
                <div className="mt-2 flex items-center gap-2 bg-white border border-slate-200 rounded-lg p-2 pr-4 shadow-sm">
          ...
          <div className="p-4 border-t border-slate-200 bg-white">
            <div className="flex items-end gap-2">
              <button className="p-3 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-xl transition-colors shrink-0">
                <Paperclip className="h-5 w-5" />
              </button>
              <div className="flex-1 bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-emerald-500 transition-all">
                <textarea 
              ...
              <button className="p-3 bg-emerald-600 text-white hover:bg-emerald-700 rounded-xl transition-colors shadow-sm shrink-0">
