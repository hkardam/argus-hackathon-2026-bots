...
export default function OfficerReports() {
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-12">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">Compliance Reports</h1>
        <p className="text-slate-500 mt-1">Review submitted progress and financial reports.</p>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                <th className="px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Report ID</th>
                <th className="px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Grant</th>
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50 transition-colors">
                <td className="px-6 py-4 font-medium text-slate-900">REP-2024-001</td>
                <td className="px-6 py-4 text-sm text-slate-600">GRT-2024-001</td>
                <td className="px-6 py-4 text-sm text-slate-900">Q1 Progress</td>
                ...
                <td className="px-6 py-4 text-right">
                  <Link to="/officer/reports" className="text-sm font-medium text-blue-600 hover:text-blue-700 flex items-center justify-end gap-1">
